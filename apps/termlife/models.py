...
class NguoiDuocBaoHiemTam(models.Model):
    nguoimuabaohiemtam = models.ForeignKey(NguoiMuaBaoHiemTam, on_delete=models.CASCADE, related_name='termlife')
    ...
    cach_tra_phi = models.IntegerField(default=0) # 1 la mot lan 2 la nhieu lan
...
class NguoiDuocBaoHiem(models.Model):
    nguoimuabaohiem = models.ForeignKey(NguoiMuaBaoHiem, on_delete=models.CASCADE, related_name='termlife')
...
class NguoiThuHuongTam(models.Model):
    nguoiduocbaohiemtam = models.ForeignKey(NguoiDuocBaoHiemTam, on_delete=models.CASCADE, related_name='termlife')
    fullname = models.CharField(max_length=200, default=None, null=True)
    birth_day = models.IntegerField(default=0)
    birth_month = models.IntegerField(default=0)
    birth_year = models.IntegerField(default=0)
...
class NguoiThuHuong(models.Model):
    nguoiduocbaohiem = models.ForeignKey(NguoiDuocBaoHiem, on_delete=models.CASCADE, related_name='termlife')
    fullname = models.CharField(max_length=200, default=None, null=True)
    birth_day = models.IntegerField(default=0)
    birth_month = models.IntegerField(default=0)
    birth_year = models.IntegerField(default=0)
...
class GoiSanPhamChinh(models.Model):
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='termlife1')
    ...
    gioi_tinh = models.IntegerField(default=0) # 0 la tat ca 1: nu,  2:nam
    tuoi = models.IntegerField(default=0) # cho tat ca so tuoi la 1000
    so_nam_hop_dong = models.IntegerField(default=0)
    so_nam_dong_phi = models.IntegerField(default=0)
    cach_tra_phi = models.IntegerField(default=0) # 1 la dong mot lan 2 la dong nhieu lan
    ten_goi_san_pham_chinh = models.CharField(max_length=255, null=True)
    id_goi_san_pham_chinh = models.IntegerField(default=0) # 1 hoanphi, 2 truyenthong, 3 thaisan
...
class GoiSanPhamPhu(models.Model):
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='termlife2')
    ten_loai_hinh_bao_hiem = models.CharField(max_length=255, null=True) 
    id_loai_hinh_bao_hiem = models.IntegerField(default=0) # xem payment
    ...
    so_nam_hop_dong = models.IntegerField(default=0)
    so_nam_dong_phi = models.IntegerField(default=0)
    cach_tra_phi = models.IntegerField(default=0) # 1 la dong mot lan 2 la dong hang nam
    ten_goi_san_pham_chinh = models.CharField(max_length=255, null=True)
