    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nguoimuabaohiem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment', to='core.NguoiMuaBaoHiem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('nguoimuabaohiemtam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment', to='core.NguoiMuaBaoHiemTam')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nguoiduocbaohiemtam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment', to='investment.NguoiDuocBaoHiemTam')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(max_length=255, null=True)),
                ('ty_le_thu_huong', models.FloatField(default=0.0)),
                ('nguoiduocbaohiem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment', to='investment.NguoiDuocBaoHiem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment2', to='core.Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ty_le_phi_rui_ro_hang_nam', models.FloatField(default=0.0)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investment1', to='core.Company')),
            ],
            options={
