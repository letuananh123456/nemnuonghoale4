...
class InfoInternationalTravelView(View):
    def get(self, request):
        return render(request, 'travelquocte/travel.html',)
...
class CompareInternationalTravelView(View):
    def get(self, request):
        return render(request, 'travelquocte/travel-compare.html')