    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loai_xe', models.IntegerField(default=0)),
                ...
                ('nguoimuabaohiemtam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tndsxemay', to='core.NguoiMuaBaoHiemTam')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ngay_ket_thuc', models.DateTimeField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('nguoimuabaohiem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tndsxemay', to='core.NguoiMuaBaoHiem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tndsxemay2', to='core.Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tndsxemay1', to='core.Company')),
            ],
            options={
