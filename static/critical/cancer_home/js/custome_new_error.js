                            ...
                            if (data.msg == "success") {
                                ...
                                if(data.lid > 0){
                                    ...
                                    /*try{
                                        ...
                                        dataLayer.push(
                                            {'event': 'eventTracking','eventCategory': 'H_BUPage_CallSchedule','eventAction': 'CallScheduleViewed','eventLabel': data.lid,'leadId':data.lid,'eventValue':valsplitvar,'nonInteraction':false}
                                        );
                                    }catch(e){}*/
                                }
