...
$.ajax({url:'http://'+document.location.host+'/templates/policybazaar/'+strPageName+'.php'+strCat,type:'GET',cache:false,beforeSend:function(data){$('#'+strDivId).html('<img class="loaderImg" src="http://'+document.location.host+'/templates/policybazaar/images/home/ajax-loader.gif" />');},success:function(data){$('#'+strDivId).html(data);}});}
